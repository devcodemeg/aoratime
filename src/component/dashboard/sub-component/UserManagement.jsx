            ...
            <table className="table table-row-dashed">
              <thead className="dashboard-thead">
                <tr>
                  ...
                  <th className="w-200px text-center">Letzer Login</th>
                  <th className="w-154px text-center">Berechtigung</th>
                  <th className="w-150px text-center">Erstellst von</th>
                  <th className="w-200px text-center">Erstellt am</th>
                  <th className="w-200px text-start">Aktiv</th>
                </tr>
              </thead>
              <tbody className="">
                      ...
                      <td className="text-center">
                        <div className="usrdtls-td">
                          <div className="prd-descrp">
                            ...
                            goebel.alexander@gmx.de                            </span>
                          </div>
                        </div>
                      </td>
                      <td className="text-center">04.10.2021 - 19:02</td>
                      <td className="text-center">
