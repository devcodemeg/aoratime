...
const PopUpAddCustomer = ({handlePopup}) => {
  const clickOnNext =() =>{
    handlePopup("pop_66")
  }
  return (
        ...
        <div className="popup-main">
          <div className="card crd-popup">
            ...
            <div class="single-input">
              ...
              <div class="authinput-wthicon">
                <input type="email" placeholder="Dummy" />
              </div>
            </div>
            <div className="popup-btn">
            <div class="pop-btns">
              <Link to="/customers" class="btn secondary-btn" onClick={clickOnNext}>
                Abort
              </Link>
            </div>
            <div class="pop-btns">
              <Link to="/customers" class="btn primary-btn" onClick={clickOnNext}>
                Save
              </Link>
            </div>
            </div>
