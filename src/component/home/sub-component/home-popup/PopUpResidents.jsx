            ...
            <div className="popup-innermain">
              ...
              <div class="rmbrfrgt-main">
                <div className="radio-main">
                  <h3>Bewohner hat sich abgemeldet?</h3>
                </div>
                <di v class="radio-btn">
              ...
              <label>Informationen</label>
                <textarea name="" id="" cols="30" rows="10" placeholder="Weitere Informatioen"></textarea>
              </div>
            </div>
              <div class="pop-btn">
              <a class="btn primary-btn" onClick={() => handlePopup("pop_11")}>
                Eintragen
              </a>
            </div>
            </div>
