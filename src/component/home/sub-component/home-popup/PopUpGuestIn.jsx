...
const PopUpGuestIn = ({ handlePopup }) => {
  const clickOnNext = () => {
    handlePopup("pop_22")
    handlePopup("pop_44")
  }
    ...
    <>
      ...
      <div className="main-popup location-modal">
        <div className="lm-outer">
            ...
            <div className="popup-inner popup-inner-sign">
              <div className="popup-header">
                <div class="popup-heading">
                  <h3>Gast einchecken</h3>
                </div>
                <div className="close-modal">
                  <span onClick={() => handlePopup("pop_22")}>
                    <svg
                      width="12"
                      height="12"
                      viewBox="0 0 12 12"
          ...
          <div className="overlay" onClick={() => handlePopup("pop_22")}></div>
        </div>
      </div>
    </>
  );
