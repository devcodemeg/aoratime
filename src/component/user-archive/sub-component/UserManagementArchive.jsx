...
const UserManagementArchive = ({handlePopup}) => {
  const hotelData = [
    {
      hotelName: "Hotel A",
      paid: 1,
          ...
          <div className="responsive-table">
            <table className="table table-row-dashed">
              <thead className="dashboard-thead">
                <tr>
                  <th className="w-100px text-center">PNR</th>
                  <th className="w-250px text-center">Benutzer</th>
                  <th className="w-250px text-start">E-Mail</th>
                  <th className="w-250px text-start">Berechitung</th>
                  <th className="w-200px text-center">Erstellet von</th>
                  <th className="w-154px text-center">Erstellt am</th>
                  <th className="w-150px text-center">Gelöscht von</th>
                  <th className="w-200px text-center">Gelöscht am</th>
                  <th className="w-200px text-start">Inaktiv</th>
                </tr>
              </thead>
              <tbody className="">
                    ...
                    <tr  className="clr">
                      ...
                      <td className="text-center">Max Murche</td>
                      ...
                      <td className="text-center">object leader</td>
                      <td className="text-center">SuperAdmin</td>
                      <td className="text-center">
