...
const CustomersArchiveList  = () => {
  ...
  return (
    <>
      <div className="card-hdr cardhdr-flexstart ">
            ...
            <table className="table table-row-dashed">
              <thead className="dashboard-thead">
                <tr>
                  ...
                  <th className="w-275px text-center">
                    <div className="main-th-hdng">
                      <div className="main-inner-hdng">
                        <p>Customer Name</p>
                      </div>
              ...
              <tr className="clr">
                  ...
                  <td className="text-center">
                    <div className="usrdetls-td ">
                      ...
                      {seletedOne === idx &&<div className="usrdetl-td-drpdwn">
                        <ul>
                          <li>
...
export default CustomersArchiveList;
