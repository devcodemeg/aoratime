  ...
  const sidebarMenu = [
    {
      ...
      icon: <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M1 8L10 1L19 8V19C19 19.5304 18.7893 20.0391 18.4142 20.4142C18.0391 20.7893 17.5304 21 17 21H3C2.46957 21 1.96086 20.7893 1.58579 20.4142C1.21071 20.0391 1 19.5304 1 19V8Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
  ...
  return (
    <aside className="sidenav">
      ...
      <div className="navbar-inner">
                  ...
                  {menus.submenus &&
                    menus.submenus.map((subMenus, subIdx) => (
                      <div
                        ...
                        className={`menu-item`}
                      >
                        <Link className={`menu-link ${activePath === subMenus.link ? "active" : ""
                          }`} to={subMenus.link}>
        ...
        <div className="asideclose-icon" onClick={removeClass}>
          <span></span>
        </div>
      </div>
    </aside>
